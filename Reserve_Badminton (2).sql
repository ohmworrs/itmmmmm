...
--
-- Host: localhost
-- Generation Time: Mar 19, 2020 at 12:16 PM
...
(1, 'คอร์ดที่1', 'ว่าง', 1, 1),
(2, 'คอร์ดที่1', 'ว่าง', 1, 1),
...
(1, 'สมศรี ใจดี', '222 กำแพงแสน นครปฐม 73140', '0999999999', 'somsri@gmail.com', 'บุคลากร');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `reserve_badminton`.`view1`  AS  select `reserve_badminton`.`badminton`.`BadmintonID` AS `BadmintonID`,`reserve_badminton`.`reserve`.`ReserveID` AS `ReserveID`,`reserve_badminton`.`badminton`.`BadmintonCourt` AS `BadmintonCourt`,`reserve_badminton`.`badminton`.`StatusCourt` AS `StatusCourt` from (`reserve_badminton`.`badminton` join `reserve_badminton`.`reserve`) where `reserve_badminton`.`badminton`.`BadmintonID` = `reserve_badminton`.`reserve`.`BadmintonID` ;
...
--
ALTER TABLE `Badminton`
  MODIFY `BadmintonID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `HistoryReserve`
  MODIFY `HistoryReserveID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `MemberBadminton`
  MODIFY `MemberBadmintonID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `RateBadminton`
--
ALTER TABLE `RateBadminton`
  MODIFY `RateBadmintonID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
